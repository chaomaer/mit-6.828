...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800cc9:	50                   	push   %eax
  800cca:	68 b3 12 80 00       	push   $0x8012b3
  800ccf:	6a 21                	push   $0x21
  800cd1:	68 c6 12 80 00       	push   $0x8012c6
  ...
  800cf1:	50                   	push   %eax
  800cf2:	68 d4 12 80 00       	push   $0x8012d4
  800cf7:	6a 23                	push   $0x23
  800cf9:	68 c6 12 80 00       	push   $0x8012c6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d4f:	56                   	push   %esi
  800d50:	50                   	push   %eax
  800d51:	68 f4 12 80 00       	push   $0x8012f4
