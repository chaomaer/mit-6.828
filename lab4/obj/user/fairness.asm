...
umain(int argc, char **argv)
{
  ...
  800096:	50                   	push   %eax
  800097:	e8 90 0c 00 00       	call   800d2c <ipc_send>
...
sys_env_destroy(envid_t envid)
{
  ...
  800abd:	68 28 13 80 00       	push   $0x801328
  800ac2:	6a 23                	push   $0x23
  800ac4:	68 45 13 80 00       	push   $0x801345
  800ac9:	e8 eb 02 00 00       	call   800db9 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4a:	e8 6a 02 00 00       	call   800db9 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b80:	68 28 13 80 00       	push   $0x801328
  800b85:	6a 23                	push   $0x23
  800b87:	68 45 13 80 00       	push   $0x801345
  800b8c:	e8 28 02 00 00       	call   800db9 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc2:	68 28 13 80 00       	push   $0x801328
  800bc7:	6a 23                	push   $0x23
  800bc9:	68 45 13 80 00       	push   $0x801345
  800bce:	e8 e6 01 00 00       	call   800db9 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c04:	68 28 13 80 00       	push   $0x801328
  800c09:	6a 23                	push   $0x23
  800c0b:	68 45 13 80 00       	push   $0x801345
  800c10:	e8 a4 01 00 00       	call   800db9 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c46:	68 28 13 80 00       	push   $0x801328
  800c4b:	6a 23                	push   $0x23
  800c4d:	68 45 13 80 00       	push   $0x801345
  800c52:	e8 62 01 00 00       	call   800db9 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800caa:	68 28 13 80 00       	push   $0x801328
  800caf:	6a 23                	push   $0x23
  800cb1:	68 45 13 80 00       	push   $0x801345
  800cb6:	e8 fe 00 00 00       	call   800db9 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800ce9:	79 16                	jns    800d01 <ipc_recv+0x3e>
		if (from_env_store != NULL) 
  800ceb:	85 f6                	test   %esi,%esi
  800ced:	74 06                	je     800cf5 <ipc_recv+0x32>
			*from_env_store = 0;
  800cef:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL)
  800cf5:	85 db                	test   %ebx,%ebx
  800cf7:	74 2c                	je     800d25 <ipc_recv+0x62>
			*perm_store = 0;
  800cf9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  800cff:	eb 24                	jmp    800d25 <ipc_recv+0x62>
		return ret;
	}

	if (from_env_store != NULL)
  800d01:	85 f6                	test   %esi,%esi
  800d03:	74 0a                	je     800d0f <ipc_recv+0x4c>
		*from_env_store = thisenv->env_ipc_from;
  800d05:	a1 04 20 80 00       	mov    0x802004,%eax
  800d0a:	8b 40 74             	mov    0x74(%eax),%eax
  800d0d:	89 06                	mov    %eax,(%esi)
	if (perm_store != NULL)
  800d0f:	85 db                	test   %ebx,%ebx
  800d11:	74 0a                	je     800d1d <ipc_recv+0x5a>
		*perm_store = thisenv->env_ipc_perm;
  800d13:	a1 04 20 80 00       	mov    0x802004,%eax
  800d18:	8b 40 78             	mov    0x78(%eax),%eax
  800d1b:	89 03                	mov    %eax,(%ebx)

	return thisenv->env_ipc_value;
  800d1d:	a1 04 20 80 00       	mov    0x802004,%eax
  800d22:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d35:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  800d3e:	85 db                	test   %ebx,%ebx
		pg = (void *) UTOP;
  800d40:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800d45:	0f 44 d8             	cmove  %eax,%ebx
  ...
  800d4c:	56                   	push   %esi
  800d4d:	57                   	push   %edi
  800d4e:	e8 0c ff ff ff       	call   800c5f <sys_ipc_try_send>
		if (ret == 0)
  800d53:	83 c4 10             	add    $0x10,%esp
  800d56:	85 c0                	test   %eax,%eax
  800d58:	74 1e                	je     800d78 <ipc_send+0x4c>
			break;
		if (ret != -E_IPC_NOT_RECV) 
  800d5a:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800d5d:	74 12                	je     800d71 <ipc_send+0x45>
			panic("sys_ipc_try_send: %e", ret);
  800d5f:	50                   	push   %eax
  800d60:	68 53 13 80 00       	push   $0x801353
  800d65:	6a 43                	push   $0x43
  800d67:	68 68 13 80 00       	push   $0x801368
  800d6c:	e8 48 00 00 00       	call   800db9 <_panic>

		sys_yield();
  800d71:	e8 7f fd ff ff       	call   800af5 <sys_yield>
	}
  800d76:	eb d0                	jmp    800d48 <ipc_send+0x1c>
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800d8b:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800d8e:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800d94:	8b 52 50             	mov    0x50(%edx),%edx
  800d97:	39 ca                	cmp    %ecx,%edx
  800d99:	75 0d                	jne    800da8 <ipc_find_env+0x28>
			return envs[i].env_id;
  800d9b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800d9e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800da3:	8b 40 48             	mov    0x48(%eax),%eax
  800da6:	eb 0f                	jmp    800db7 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800dab:	3d 00 04 00 00       	cmp    $0x400,%eax
  800db0:	75 d9                	jne    800d8b <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dc7:	e8 0a fd ff ff       	call   800ad6 <sys_getenvid>
  800dcc:	83 ec 0c             	sub    $0xc,%esp
  800dcf:	ff 75 0c             	pushl  0xc(%ebp)
  800dd2:	ff 75 08             	pushl  0x8(%ebp)
  800dd5:	56                   	push   %esi
  800dd6:	50                   	push   %eax
  800dd7:	68 74 13 80 00       	push   $0x801374
  800ddc:	e8 ab f3 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800de1:	83 c4 18             	add    $0x18,%esp
  800de4:	53                   	push   %ebx
  800de5:	ff 75 10             	pushl  0x10(%ebp)
  800de8:	e8 4e f3 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800ded:	c7 04 24 af 10 80 00 	movl   $0x8010af,(%esp)
  800df4:	e8 93 f3 ff ff       	call   80018c <cprintf>
  800df9:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800dfc:	cc                   	int3   
  800dfd:	eb fd                	jmp    800dfc <_panic+0x43>
  800dff:	90                   	nop
