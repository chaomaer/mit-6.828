...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002ec:	ff 24 85 34 0e 80 00 	jmp    *0x800e34(,%eax,4)
  ...
  8003cd:	8b 14 85 8c 0f 80 00 	mov    0x800f8c(,%eax,4),%edx
  8003d4:	85 d2                	test   %edx,%edx
  8003d6:	75 19                	jne    8003f1 <vprintfmt+0x17e>
				printfmt(putch, putdat, "error %d", err);
  8003d8:	50                   	push   %eax
  8003d9:	68 bd 0d 80 00       	push   $0x800dbd
  ...
  8003f1:	52                   	push   %edx
  8003f2:	68 c6 0d 80 00       	push   $0x800dc6
  ...
  800417:	b8 b6 0d 80 00       	mov    $0x800db6,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a6e:	68 a8 0f 80 00       	push   $0x800fa8
  800a73:	6a 23                	push   $0x23
  800a75:	68 c5 0f 80 00       	push   $0x800fc5
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ac2:	56                   	push   %esi
  800ac3:	50                   	push   %eax
  800ac4:	68 d4 0f 80 00       	push   $0x800fd4
  ...
  800ad5:	e8 11 f6 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800ada:	c7 04 24 f8 0f 80 00 	movl   $0x800ff8,(%esp)
