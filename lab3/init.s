...
.LC3:
	...
	.align 8
.LC4:
	.string	"Welcome to %Cc%Ccaomaer's minimal OS\n"
	.section	.text.unlikely
.LCOLDB5:
	.text
.LHOTB5:
...
.LM17:
	call	cons_init
	.stabn	68,0,35,.LM18-.LFBB2
.LM18:
	movl	$6828, %esi
	movl	$.LC3, %edi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,36,.LM19-.LFBB2
.LM19:
	movl	$.LC4, %edi
	movl	$104, %r8d
	movl	$1, %ecx
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L10:
	.stabn	68,0,58,.LM23-.LFBB3
.LM23:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,61,.LM24-.LFBB3
.LM24:
	cmpq	$0, panicstr(%rip)
	je	.L15
	.p2align 4,,10
...
.LM26:
	...
	.stabn	68,0,66,.LM27-.LFBB3
.LM27:
#APP
# 66 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,68,.LM28-.LFBB3
.LM28:
#NO_APP
	leaq	224(%rsp), %rax
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L17:
	.stabn	68,0,83,.LM35-.LFBB4
.LM35:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,86,.LM36-.LFBB4
.LM36:
	leaq	224(%rsp), %rax
